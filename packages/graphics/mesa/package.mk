...
PKG_NAME="mesa"
PKG_VERSION="20.3.0"
PKG_SHA256="d055c089b13dab38429742252044fa944d4f826476cdb87b1ea00a30727c04e2"
PKG_LICENSE="OSS"
...
if [ ${#PKG_VERSION} == 40 ]; then
  PKG_URL="https://gitlab.freedesktop.org/mesa/mesa/-/archive/master/mesa-${PKG_VERSION}.tar.gz"
else
  PKG_URL="https://gitlab.freedesktop.org/mesa/mesa/-/archive/mesa-${PKG_VERSION}/mesa-${PKG_VERSION}.tar.gz"
fi
